...
/**
 * FormopSearch represents the model behind the search form of `common\models\referral\Formop`.
 */
class FormopSearch extends Formop
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['formop_id', 'agency_id', 'print_format'], 'integer'],
