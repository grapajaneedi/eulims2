...
class Printing {
    ...
    private function FastReport($id){
        ...
        if ($RstlDetails) {
            ...
            $RequestTemplate .= "<thead><tr><td colspan='7' style='height: 10px;text-align: center'>&nbsp;</td></tr></thead>";
            $RequestTemplate .= "<tr>";
            ...
            $RequestTemplate .= "<td>12345</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td>Recodo Zamboanga City</td>";
            $RequestTemplate .= "<td colspan='3'>&nbsp;</td>";
            $RequestTemplate .= "<td>11/14/2018</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td>Tel Fax #</td>";
            $RequestTemplate .= "<td colspan='3'>&nbsp;</td>";
            $RequestTemplate .= "<td>PR #/PO #</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td>Project Name</td>";
            $RequestTemplate .= "<td colspan='3'>&nbsp;</td>";
            $RequestTemplate .= "<td>TIN #</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            ...
            $RequestTemplate .= "<td>&nbsp;</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr><td colspan='7' style='height: 20px;text-align: center'>&nbsp;</td></tr>";
            $CounterLimit=12;
            for($counter=1;$counter<=$CounterLimit;$counter++){
                $RequestTemplate .= "<tr>";
                $RequestTemplate .= "<td style='text-align: center'>23</td>";
                ...
                $RequestTemplate .= "<td style='text-align: right'>11234.00</td>";
                $RequestTemplate .= "</tr>";
            }
            $RequestTemplate .= "<tr>";
            ...
            $RequestTemplate .= "<td></td>";
            $RequestTemplate .= "<td></td>";
            $RequestTemplate .= "<td style='text-align: right'>0.00</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            ...
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td style='text-align: right'>Nolan F. Sunico</td>";
            $RequestTemplate .= "<td style='text-align: right'>11/14/2018 04:32 PM</td>";
            $RequestTemplate .= "<td>&nbsp;</td>";
            $RequestTemplate .= "<td></td>";
            $RequestTemplate .= "<td style='text-align: right'>0.00</td>";
            $RequestTemplate .= "</tr>";
