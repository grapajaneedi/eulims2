...
class Printing {
    ...
    private function FastReport($id){
        ...
        if ($RstlDetails) {
            ...
            $RequestTemplate .= "<td>&nbsp;</td>";
            $RequestTemplate .= "<td>&nbsp;</td>";
            $RequestTemplate .= "<td style='text-align: right;padding-right: 10px'>tot.am</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='4' style='height: 5px;font-size: 8px;font-weight: bold'>";
            ...
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td style='text-align: left;padding-left: 40px'>Nolan F. Sunico</td>";
            ...
            $RequestTemplate .= "<td colspan='4'>&nbsp;</td>";
            $RequestTemplate .= "<td colspan='2'>&nbsp;</td>";
            $RequestTemplate .= "<td style='text-align: right;padding-right: 10px'>tot.pa</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='6' rowspan='2'>Spcial Instructions</td>";
            $RequestTemplate .= "<td style='text-align: right;padding-right: 10px'>Deposit O.R</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td style='text-align: right;padding-right: 10px'>Bal.00</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td colspan='7' style='padding-left: 5px'>&nbsp;</td>";
            $RequestTemplate .= "</tr>";
            $RequestTemplate .= "<tr>";
            ...
            $RequestTemplate .= "<tr><td colspan='4' style='height: 20px;text-align: center'>&nbsp;</td></tr>";
            $RequestTemplate .= "<tr>";
            $RequestTemplate .= "<td>Printed Name and Signature</td>";
