        ...
        <?php
            ...
            echo GridView::widget([
                ...
                'panel' => [
                    ...
                    Html::button('<i class="glyphicon glyphicon-plus"></i> Additional Fees', ['value' => Url::to(['/lab/fee/create','request_id'=>$model->request_id]),'title'=>'Add Additional Fees', 'onclick'=>'addSample(this.value,this.title)', 'class' => 'btn btn-success','id' => 'modalBtn']),
                   'after'=>false,
