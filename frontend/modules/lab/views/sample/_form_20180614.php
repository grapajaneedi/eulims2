...
//foreach ($list as $lists)
{
    ...
    //echo $lists['[labcode]'];
    //echo $list."<br />";
    if (strpos($list[$i], 'labcode') !== false) {
        //echo 'true';
        //$list[$i] = $labcode;
       //$list[$i] = $labcode;
        //public $labcode;
    ...
    if (strpos($list[$i], '#') !== false) {
        ...
        //$list[$i] = $series;
       // public $series; 
        echo $series = str_pad(1, strlen($list[$i]), "0", STR_PAD_LEFT);
    }

    if (strpos($list[$i], 'y') !== false) {
        //echo 'true';
        //echo $list[$i];
        //$list[$i] = $year;
       // public $year;
