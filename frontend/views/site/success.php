...
<div class="body-content" style="margin:10%;background:#b1d1e4;"  >
    ...
    <div class="d-flex align-items-left" >
        ...
        <div class="row" style="text-align:center">
            <div class="col-md-12 ">
                <p style="font-family: 'Audiowide';font-size:30px;color:#1b4f72;text-align:center;vertical-align: central;color:Green">Hi <?= $model->username ?>!</p>
            </div>

        </div>
        <div class="row" style="text-align:center">
            <div class="col-md-12 ">
                <p style="font-family: 'Audiowide';font-size:20px;color:#1b4f72;text-align:center;vertical-align: central;color:Green">Signed Up Successful</p>
            </div>

        </div>
        <div class="row"> 
            <p style="font-family: 'Audiowide';font-size:15px;color:#1b4f72;text-align:center;vertical-align: central;color:green">
                Please check your email: <strong><?= $model->email ?></strong> to verify your account.
            </p>
        </div>
        <div class="row">
